...
public static class MirageAPI
{
    ...
    public static class Public
    {
        ...
        public static async Task<SPublicDataset?> PublicDataset([Optional]string page, [Optional]string filter, [Optional]string projectId)
        {
    ...
    public static class Private
    {
        ...
        public static class Dreambooth
        {
            ...
            /// <returns>Completed request</returns>
            public static async Task<SCreateProject> CreateProject(SClientAuthorization authorization, SCreateProjectBody body)
            {
                RestRequest req = new RestRequest("/dreambooth/project");
                AddAuthHeaders(authorization, ref req);
                req.AddBody(body);
            ...
            public struct SGetProject
    {
        ...
        public struct SNode
        {
            ...
            [JsonProperty("init_word")]
            [JsonPropertyName("init_word")]
            public string InitWord;

            [JsonProperty("train_iterations")]
            [JsonPropertyName("train_iterations")]
            ...
            [JsonProperty("finetune_job_status")]
            [JsonPropertyName("finetune_job_status")]
            ...
            public struct SCreateProject
            {
                ...
                [JsonPropertyName("uploadedFileLength")]
            ...
            public struct SCreateRunBody
            {
                ...
                [JsonProperty("num-images")]
                [JsonPropertyName("num-images")]
                public string NumImages;

                [JsonProperty("prompt-strength")]
                [JsonPropertyName("prompt-strength")]
                ...
                [JsonProperty("num-inference-steps")]
                [JsonPropertyName("num-inference-steps")]
                public int NumInferenceSteps;

                [JsonProperty("guidance-scale")]
                [JsonPropertyName("guidance-scale")]
        ...
        public static class TextureMesh
        {
            ...
            /// <returns></returns>
            public static async Task<SGetProjects> GetProjects(SClientAuthorization authorization, string cursor, string sort = "descending")
            {
            ...
            /// <returns></returns>
            public static async Task<SCreateProject> CreateProject(SClientAuthorization authorization, SCreateProjectBody prompt)
            {
            ...
            /// <returns></returns>
            public static async Task<SCreateProject> UploadProject(SClientAuthorization authorization, SUploadProjectBody body)
            {
            ...
            public struct SGetProjects
    {
        ...
        public struct SNode
            {
                ...
                [JsonProperty("text_mesh_runsCollection")]
                [JsonPropertyName("text_mesh_runsCollection")]
                ...
                [JsonProperty("square_func")]
                [JsonPropertyName("square_func")]
                public string SquareFunc;
        
                [JsonProperty("generate_maps")]
                [JsonPropertyName("generate_maps")]
                public bool GenerateMaps;
        
                [JsonProperty("make_tileable")]
                [JsonPropertyName("make_tileable")]
        ...
        public struct Datum
        {
            ...
            public struct SCreateRunBody
            {
                ...
                [JsonPropertyName("generate-maps")]
                public bool GenerateMaps;
                ...
                [JsonProperty("super-resolution")]
                [JsonPropertyName("super-resolution")]
                ...
                [JsonProperty("make-tileable")]
                [JsonPropertyName("make-tileable")]
                public bool MakeTileable;
        ...
        {
            if (authorization.AuthorizationToken== String.Empty) throw new ArgumentException("Authorization key is empty!");
